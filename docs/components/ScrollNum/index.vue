...
.scroll-num {
  ...
  height: var(--height, calc(var(--width, 24px) * 1.8));
  color: var(--color, #00fff9);
  font-size: var(--height, calc(var(--width, 24px) * 1.1));
  line-height: var(--height, calc(var(--width, 24px) * 1.8));
  text-align: center;
  font-family: "LcdD";
  overflow: hidden;
}
